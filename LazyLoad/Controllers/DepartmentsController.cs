...
namespace LazyLoad.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,EmployeeId,DepartmentName,Description")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,EmployeeId,DepartmentName,Description")] Departments departments)
        {
            if (ModelState.IsValid)
            {
